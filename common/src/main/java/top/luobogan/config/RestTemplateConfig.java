...
public class RestTemplateConfig {
    ...
    public HttpClient httpClient(){
        ...
        /**
         * 只请求 luobogan.top,最大并发300
         * 请求 luobogan.top,最大并发300
         * 请求 open1024.com,最大并发200
         * //MaxtTotal=400 DefaultMaxPerRoute=200
         * //只连接到http://luobogan.top时，到这个主机的并发最多只有200；而不是400；
         * //而连接到http://luobogan.top 和 http://open1024.com时，到每个主机的并发最多只有200；
         * // 即加起来是400（但不能超过400）；所以起作用的设置是 DefaultMaxPerRoute。
         */
